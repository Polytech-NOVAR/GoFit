...
public class EvDetailsPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public EvDetailsPanel(ConnectedWindow frame, MainFacade facade, Event Ev,Activity act) {
		this.facade = facade;
		...
		if(Ev != null)
		{
			...
			textFieldNbOccur.setEnabled(false);
