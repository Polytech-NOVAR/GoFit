...
public class PanelEvents extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelEvents(ConnectedWindow frame, MainFacade facade, Activity act) {
		this.facade = facade;
	...
	private void seeMore(Event Ev){
		this.mainFrame.changePanel(new PanelEvDetails(this.mainFrame, this.facade, this.Ev,act));
	}

	private void addOne(){
		this.mainFrame.changePanel(new PanelEvDetails(this.mainFrame, this.facade, null,act));
	}
