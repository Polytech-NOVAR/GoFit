...
public class DeleteEvDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DeleteEvDialog(ConnectedWindow frame, MainFacade facade,Event Ev, Activity act) {
		...
		String text = "Do you really want to delete the Event "+act.getActName()+" ?";
	...
	private void delete()
	{
		this.facade.getActEvFacade().deleteEvent(Ev);
		this.mainFrame.changePanel(new EventsPanel(this.mainFrame, this.facade, act));
		this.dispose();
	}
