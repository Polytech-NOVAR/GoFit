...
public class RegDetailsPanel extends JPanel {
	...
	public RegDetailsPanel(ConnectedWindow frame, MainFacade facade, Event Ev) {
	...
	private void create() throws FalseFieldsException{
		this.mainFrame.changePanel(new AddRegPanel(this.mainFrame, this.facade, this.Ev));
	}

	private void delete(Registration reg)
	{	DeleteRegDialog delete = new DeleteRegDialog(this.mainFrame, this.facade, Ev,reg);
	delete.setVisible(true);
	this.mainFrame.changePanel(new RegDetailsPanel(this.mainFrame, this.facade,Ev));
