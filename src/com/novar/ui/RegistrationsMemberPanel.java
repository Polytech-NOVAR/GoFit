...
public class RegistrationsMemberPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public RegistrationsMemberPanel(ConnectedWindow frame, MainFacade facade) {
		this.facade = facade;
	...
	private void seeMore(Event Ev){
		this.mainFrame.changePanel(new EvDetailsPanel(this.mainFrame, this.facade, Ev,act));
	}
