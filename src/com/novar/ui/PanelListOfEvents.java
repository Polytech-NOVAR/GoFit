...
public class PanelListOfEvents extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelListOfEvents(ConnectedWindow frame, MainFacade facade) {
		this.facade = facade;
	...
	private void cancel()
	{
		...
		this.mainFrame.changePanel(new PanelRegistrationsMember(this.mainFrame, this.facade));
	}
	private void addOne() 
	{
