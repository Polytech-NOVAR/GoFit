...
public class ActivitiesPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ActivitiesPanel(ConnectedWindow frame, MainFacade facade) {
		this.facade = facade;
	...
	private void seeMore(Activity act){
		this.mainFrame.changePanel(new ActDetailsPanel(this.mainFrame, this.facade, act));
	}

	private void addOne(){
		this.mainFrame.changePanel(new ActDetailsPanel(this.mainFrame, this.facade, null));
	}
